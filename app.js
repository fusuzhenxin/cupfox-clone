...
const FOOT = `<footer><div class="wrap foot-in">
...
const MODAL = `<div class="modal" id="modal"><div class="search-box">
  <input id="searchInput" placeholder="搜索电影、剧集、演员、导演、片单…" autocomplete="off" />
  <div class="hot"><span>豆瓣高分</span><span>悬疑</span><span>科幻</span><span>美剧</span><span>日漫</span><span>宫崎骏</span><span>复仇者联盟</span></div>
